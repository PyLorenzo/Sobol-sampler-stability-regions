...
Visualisation of the TPM stability map produced by tpm_stability_map.py.
...
(B) Corner-style MARGINAL-FRACTION heatmap: each off-diagonal panel shows the
    ...
    stability label over the other two parameters. This is the "probability
    of stability" map.

Usage
-----
    python tpm_stability_viz.py tpm_stability_map.pkl
    python tpm_stability_viz.py tpm_stability_map.pkl --bins 30 --outdir ./figs
"""
...
def scatter_corner(data: dict, outpath: str,
    ...
    #fig.suptitle("TPM stability map – scatter projections", y=0.995)
...
def marginal_fraction_corner(data: dict, outpath: str,
    ...
    #fig.suptitle("TPM stability map – marginal stable fraction", y=0.995)
...
def main():
    ...
    ap.add_argument("pickle_path",
                    help="Pickle written by tpm_stability_map.py")
    ...
    scatter_path = os.path.join(args.outdir, "tpm_stability_scatter.png")
    heatmap_path = os.path.join(args.outdir, "tpm_stability_heatmap.png")
